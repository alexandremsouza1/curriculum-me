...
const toolingData = [
  ...
  },
  {
    skill: "Cloud",
    siblings: [
      { skill: "AWS", years: 0.5, rating: 1 },
      { skill: "GCP", years: 0.5, rating: 1 },
    ],
    years: 0.5,
    rating: 0,
  },
...
const backendSkillsData = [
  {
    ...
    siblings: [
      ...
      { skill: "Go (Golang)", years: 2, rating: 0 },
...
const devopsSkillsData = [
  {
    skill: "CI/CD",
    siblings: [
      { skill: "Travis", years: 0.5, rating: 0 },
      { skill: "CircleCI", years: 0.5, rating: 0 },
      { skill: "GitLab", years: 2, rating: 0 },
    ],
    years: 4,
    rating: 0,
  },
  {
    skill: "Contêinerização e Orquestração",
    siblings: [
      { skill: "Docker", years: 0.5, rating: 0 },
      { skill: "Kubernetes", years: 0.5, rating: 0 },
    ],
    years: 4,
    rating: 0,
  },
  {
    skill: "Monitoramento e Logging",
    siblings: [
      { skill: "Prometheus", years: 0.5, rating: 0 },
      { skill: "Grafana", years: 0.5, rating: 0 },
      { skill: "Elasticsearch", years: 0.5, rating: 0 },
      { skill: "Logstash", years: 0.5, rating: 0 },
      { skill: "Kibana", years: 0.5, rating: 0 },
    ],
    years: 4,
    rating: 0,
  },
  {
    skill: "IaC",
    siblings: [{ skill: "Terraform", years: 0.5, rating: 0 }],
    years: 4,
    rating: 0,
  },
  {
    skill: "Code Quality",
    siblings: [{ skill: "SonarQube", years: 0.5, rating: 0 }],
    years: 4,
    rating: 0,
  },
  {
    ...
    siblings: [
      { skill: "Datadog: ", years: 0.5, rating: 0 },
      { skill: "CloudWatch", years: 0.5, rating: 0 },
    ],
    years: 4,
    rating: 0,
  },
  {
    skill: "Pipeline",
    siblings: [{ skill: "Argo CD: ", years: 0.5, rating: 0 }],
    years: 4,
    rating: 0,
  },
];
    ...
    <View style={styles.section}>
      ...
      {data.map((item) => (
        <View style={styles.segment} wrap={false}>
          <View style={styles.row}>
            {SkillRow(item.skill, item.years, item.rating, item.siblings)}
          </View>
          <View style={styles.row}>
            {item.siblings && (
              <Image style={styles.expand_arrow} src={"assets/arrow.png"} />
            )}
            {item.siblings &&
              item.siblings.map((subitem) => (
                <View style={styles.subrow}>
                  {SkillRow(subitem.skill, subitem.years, subitem.rating)}
                </View>
              ))}
          </View>
        </View>
      ...
      {/* <Text break={true} style={{ paddingTop: 5 }} /> */}
      <View style={styles.row}>
      ...
      {/* <Text break={true} style={{ paddingTop: 5 }} /> */}
      <View style={styles.row}>
        <Text style={[styles.head, { flex: 1 }]}>DevOps Skills</Text>
      </View>
